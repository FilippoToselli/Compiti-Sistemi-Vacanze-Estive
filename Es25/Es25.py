...
def print_first_and_last(sentence):
    """Prints the first and last words of the sntence"""
    words = break_words(sentence)
...
#   > With documentation string it's possible describe what a method does, and what attribute it needs.
...
#   > It's no longer necessary call a method using the module (Es25.break_words() --> break_words())
